...
class App:
    ...
    def load_icons(self):
        ...
        expand_folder_img = Image.open("assets/expand_folder.png").resize((16, 16))
        collapse_folder_img = Image.open("assets/collapse_folder.png").resize((16, 16))
        file_img = Image.open("assets/file.png").resize((16, 16))
        ntfs_partition_img = Image.open("assets/ntfs_partition.png").resize((16, 16))
        fat32_partition_img = Image.open("assets/fat32_partition.png").resize((16, 16))
        refresh_img = Image.open("assets/refresh.png").resize((16, 16))
        
        # Load file type specific icons
        audio_img = Image.open("assets/audio.png").resize((16, 16))
        image_img = Image.open("assets/image.png").resize((16, 16))
        pdf_img = Image.open("assets/pdf.png").resize((16, 16))
        word_img = Image.open("assets/word.png").resize((16, 16))
        excel_img = Image.open("assets/excel.png").resize((16, 16))
        powerpoint_img = Image.open("assets/powerpoint.png").resize((16, 16))
        text_img = Image.open("assets/text.png").resize((16, 16))
        zip_img = Image.open("assets/zip.png").resize((16, 16))
        rar_img = Image.open("assets/rar.png").resize((16, 16))
        executable_img = Image.open("assets/executable.png").resize((16, 16))
        video_img = Image.open("assets/video.png").resize((16, 16))
        code_img = Image.open("assets/code.png").resize((16, 16))
